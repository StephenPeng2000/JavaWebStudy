create database day09_homework;
use day09_homework;
-- 部门表
CREATE TABLE dept
(
...
select e.ename, e.salary, j.jname, j.description, d.dname, d.loc, g.grade
from emp as e
         inner join dept d on e.dept_id = d.id
         inner join job j on e.job_id = j.id
         inner join salarygrade g
where e.salary between g.losalary and g.hisalary;
